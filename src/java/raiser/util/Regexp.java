...
public class Regexp
{
    ...
    /**
     * Escapes a char sequence for using as a pattern text into 
     * a regular expression. 
     * For example matching for point or dollar sign. 
     * @param data
     * @return
     */
    ...
    public static String escapeVariable(
        String command,
        String name,
        String value)
    {
        return command.replaceAll(Regexp.escapeVariable(name),Regexp.escapeValue(value));
    }
}
