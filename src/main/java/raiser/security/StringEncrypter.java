...
public class StringEncrypter
{
    ...
    public StringEncrypter(char[] passPhrase)
    {
        ...
        try
        {
            ...
            KeySpec keySpec =
                new PBEKeySpec(passPhrase, salt, iterationCount);
            SecretKey key =
    ...
    public byte[] encryptFromString(String data) throws IllegalStateException, IllegalBlockSizeException, BadPaddingException
    {
        return encrypt(data.getBytes());
    }
    public String decryptToString(byte[] data) throws IllegalStateException, IllegalBlockSizeException, BadPaddingException
    {
     ...
     */
    public static void testUsingSecretKey() throws IllegalStateException, IllegalBlockSizeException, BadPaddingException
    {
        try
        {
            ...
            StringEncrypter desEncrypter =
                new StringEncrypter(desKey, desKey.getAlgorithm());
            StringEncrypter blowfishEncrypter =
                new StringEncrypter(blowfishKey, blowfishKey.getAlgorithm());
            StringEncrypter desedeEncrypter =
                new StringEncrypter(desedeKey, desedeKey.getAlgorithm());

            // Encrypt the string
            byte[] desEncrypted = desEncrypter.encryptFromString(secretString);
            byte[] blowfishEncrypted = blowfishEncrypter.encryptFromString(secretString);
            byte[] desedeEncrypted = desedeEncrypter.encryptFromString(secretString);

            // Decrypt the string
            String desDecrypted = desEncrypter.decryptToString(desEncrypted);
            String blowfishDecrypted =
                blowfishEncrypter.decryptToString(blowfishEncrypted);
            String desedeDecrypted = desedeEncrypter.decryptToString(desedeEncrypted);
            ...
            System.out.println(
                blowfishKey.getAlgorithm() + " Encryption algorithm");
            System.out.println("    Original String  : " + secretString);
            ...
            System.out.println(
                desedeKey.getAlgorithm() + " Encryption algorithm");
            System.out.println("    Original String  : " + secretString);
     ...
     */
    public static void testUsingPassPhrase() throws IllegalStateException, IllegalBlockSizeException, BadPaddingException
    {
        ...
        System.out.println("    Original String  : " + secretString);
        System.out.println("    Encrypted String : " + new String(desEncrypted));
        System.out.println("    Decrypted String : " + desDecrypted);
        System.out.println();
     ...
     */
    public static void main(String[] args) throws IllegalStateException, IllegalBlockSizeException, BadPaddingException
    {
        testUsingSecretKey();
        testUsingPassPhrase();
    }
