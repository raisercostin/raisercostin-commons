...
public class SimpleProxy {
	 ...
	 * res.setProperty("raiser.cmd",line); sb.append(line+"\n"); }else{
	 * pos=line.indexOf(':'); if(pos>0)
	 * res.setProperty(line.substring(0,pos).trim(),line.substring(pos+1).trim());
	 * else if(pos<=0) res.setProperty("raiser.unknown",line);
	 * sb.append(line+"\n"); } System.out.println("("+line+")"); }
	 * res.setProperty("raiser.content",sb.toString());
	 * res.setProperty("raiser.server","ctache"); }catch(IOException e){
