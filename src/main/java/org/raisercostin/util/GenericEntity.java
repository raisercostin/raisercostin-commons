 ...
 * required to select a suitable {@link MessageBodyWriter}, this class may be used to wrap the entity and capture its
 * generic type.
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * where <code>list</code> is the instance of <code>List&lt;String&gt</code> that will form the response body and entity
 * is an instance of an anonymous subclass of {@code GenericEntity}.
 * </p>
 * </li>
...
public class GenericEntity<T> {
	...
	/**
	 * Create a new instance of GenericEntity, supplying the generic type information. The entity must be assignable to
	 * a variable of the supplied generic type, e.g. if {@code entity} is an instance of {@code ArrayList<String>} then
	 ...
	 * @throws IllegalArgumentException
	 *             if the entity is not assignable to a variable of the supplied generic type or if entity or
	 *             genericType is null.
	 */
	...
	/**
	 * Gets underlying {@code Type} instance. Note that this is derived from the type parameter, not the enclosed
	 * instance. I.e. in the example in the introduction, the type is {@code List<String>} not {@code ArrayList<String>}
	 * .
	 * 
	 * @return the type
	 */
