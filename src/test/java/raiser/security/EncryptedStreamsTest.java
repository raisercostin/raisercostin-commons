...
public class EncryptedStreamsTest extends TestCase
{
            ...
            IllegalBlockSizeException, BadPaddingException, IOException
    {
        ...
        OutputStream out = new EncryptedOutputStream(bout, passPhrase.toCharArray());
        ...
        InputStream desDecrypter = new EncryptedInputStream(in, passPhrase.toCharArray());
    ...
    public void test5() throws IOException
    {
        /*
         ...
         "d:\\workspace\\selfim\\xml.out"), "costin");
         resultedLength = in.read(buffer);
         in.close();
